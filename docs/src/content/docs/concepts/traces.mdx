...
- [Git Artifact Store](/runbook/guides/git-artifact-store/) — persist traces as git objects
- [`@f0rbit/runbook`](/runbook/packages/core/) — `TraceCollector` and `TraceEvent` exports
- [Architecture](/runbook/resources/architecture/) — how traces fit into the system
